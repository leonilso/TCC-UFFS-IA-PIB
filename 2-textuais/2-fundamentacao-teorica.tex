...
% Cao o professor esteja vendo esse texto au ainda não montei os bibtex do parágrafo abaixo assim que montar já referencio

Trataremos da relação entre variáveis reais e monetárias, além da expectativa com a noção de incerteza com texto de Fialho. Observaremos o PIB per capita sob uma análise regional brasileira do ponto de vista de Oliveira e Junior. Notaremos o impacto internacional no PIB brasileiro através das medidas tarifárias pela perspectiva de Domingues. Por último recorreremos a literatura internacional, para observar como uma variação do modelo VAR é utilizada para estimar o crescimento do \ac{gdp} estadunidense proposto por Koo.
