...
Retomando o conceito de \citeonline{ghosh2023machine} entendemos o que são as redes, e o que são os nós, se tratam dos neurônios conectados e os pesos calculados de cada um. Contudo um conceito relevante que ainda não foi discutido, é a retropropagação, que é justamente o que permite o aprendizado nessa arquitetura.
